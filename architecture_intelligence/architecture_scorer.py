...
class ArchitectureScorer:
    ...
    DIMENSIONS: dict[str, list[str]] = {
        "scalability": [
            "horizontal scaling", "auto-scaling", "stateless", "queue",
            "load balancer", "sharding", "partitioning", "caching",
        ],
        "reliability": [
            "replica", "failover", "circuit breaker", "retry", "health check",
            "graceful degradation", "backup", "redundancy",
        ],
        "security": [
            "authentication", "authorization", "rbac", "encrypt", "tls",
            "jwt", "oauth", "api key", "rate limiting", "waf",
        ],
        "maintainability": [
            "opentelemetry", "logging", "tracing", "monitoring", "alert",
            "documentation", "api versioning", "ci/cd", "testing",
        ],
        "cost": [
            "serverless", "managed service", "auto-scaling", "spot instance",
            "right-sizing", "reserved", "cost estimate", "budget",
        ],
    }
