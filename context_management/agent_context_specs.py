...
AGENT_CONTEXT_SPECS: dict[str, AgentContextSpec] = {
    ...
    "agent_0_decompose": AgentContextSpec(
        ...
        required_fields=[
            "user_prompt", "provider_manifest",
            "workspace_context", "model_router_context",
        ],
        optional_fields=["memory_context"],
        excluded_fields=[
            "review_findings", "security_findings", "generated_files",
            "interpret_log", "session_token_records", "ci_pipeline_url",
        ],
    ...
    "agent_2_stack": AgentContextSpec(
        ...
        required_fields=[
            "user_prompt", "prd", "service_graph", "model_router_context",
        ],
        optional_fields=["memory_context"],
        excluded_fields=[
            "review_findings", "security_findings", "generated_files",
    ...
    "agent_3_architecture": AgentContextSpec(
        ...
        required_fields=[
            "user_prompt", "prd", "adr", "service_graph",
            "workspace_context", "model_router_context",
        ],
    ...
    "agent_4_tool_router": AgentContextSpec(
        ...
        required_fields=[
            "prd", "rfc", "adr", "workspace_context",
            "model_router_context", "tool_router_context",  # ← required: delegates code gen
        ],
        optional_fields=["memory_context"],
        excluded_fields=[
            "review_findings", "security_findings",
            "interpret_log", "session_token_records", "monitoring_config",
        ],
        max_context_tokens=8_000,
        summarise_threshold_tokens=2_000,
        memory_layers=[4],
    ...
    "agent_5_coord_review": AgentContextSpec(
        ...
        required_fields=[
            "rfc", "adr", "model_router_context", "tool_router_context",
        ],
        optional_fields=["generated_files", "memory_context"],
        excluded_fields=[
            "user_prompt", "prd", "security_findings",
            "interpret_log", "session_token_records",
        ],
    ...
    "agent_5b_security": AgentContextSpec(
        ...
        optional_fields=["generated_files", "memory_context"],
        excluded_fields=[
            "user_prompt", "prd", "interpret_log", "session_token_records",
        ],
        max_context_tokens=12_000,
        summarise_threshold_tokens=2_000,
        memory_layers=[2, 5],
    ...
    "agent_6_test_coord": AgentContextSpec(
        ...
        required_fields=[
            "rfc", "workspace_context",
            "model_router_context", "tool_router_context",  # ← required: delegates test gen
        ],
        optional_fields=["generated_files", "memory_context"],
        excluded_fields=[
            "user_prompt", "prd", "interpret_log",
            "session_token_records", "monitoring_config",
        ],
        max_context_tokens=10_000,
        summarise_threshold_tokens=2_000,
        memory_layers=[2],
    ...
    "agent_7_cicd": AgentContextSpec(
        ...
        optional_fields=["memory_context"],
        excluded_fields=[
            "user_prompt", "prd", "review_findings", "security_findings",
            "interpret_log", "session_token_records",
        ],
    ...
    "agent_11_integration": AgentContextSpec(
        ...
        required_fields=[
            "service_graph", "rfc", "workspace_context", "model_router_context",
        ],
        optional_fields=["memory_context"],
        excluded_fields=[
            "user_prompt", "prd", "review_findings",
